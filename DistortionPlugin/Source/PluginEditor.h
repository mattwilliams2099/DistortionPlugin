...
private:
    ...
    void setLabel (juce::Label& label, 
                   ...
                   std::string name, 
                   bool attach = true);
    void setTitle (juce::Label& lable, 
                   std::string name);
    ...
    juce::Slider driveSlider, foldThreshSlider, offsetSlider, foldOutSlider, crushMixSlider, 
                 sClipInSlider, posAlphaSlider, posThreshSlider, negAlphaSlider, negThreshSlider, 
                 sClipOutSlider, clipMixSlider, wetDrySlider, outputGainSlider;
    juce::Label driveLabel,  foldThreshLabel,  offsetLabel,  foldOutLabel,  crushMixLabel,  
                stepsLabel, sClipInLabel, posAlphaLabel, posThreshLabel, negAlphaLabel, negThreshLabel, 
                sClipOutLabel, clipMixLabel, symmetryLabel, wetDryLabel, outputGainLabel, folderLabel, 
                clipperLabel, crusherLabel, utilitiesLabel;
    juce::ToggleButton symmetryToggle;
    juce::TextButton twoButton{ "2" }, 
                     fourButton{ "4" }, 
                     eightButton{ "8" }, 
                     sixteenButton{ "16" };
